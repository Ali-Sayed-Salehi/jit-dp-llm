...
accelerate launch --config_file=$REPO_ROOT/llama/configs/accelerate_config_fsdp.yaml --num_machines=$SLURM_NNODES --machine_rank=$SLURM_NODEID $REPO_ROOT/llama/train.py --config $REPO_ROOT/llama/configs/train_config_local.yaml
