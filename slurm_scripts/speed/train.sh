...
#SBATCH --job-name=train-llama-mozilla-jit
...
--config /speed-scratch/a_s87063/repos/jit-dp-llm/llama/configs/templates/train_config_speed_llama_mozilla_jit.yaml
