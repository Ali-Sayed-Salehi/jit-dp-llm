...
python /speed-scratch/a_s87063/repos/perf-pilot/llama/causal_lm.py --live_metrics --dataset_path /speed-scratch/a_s87063/repos/perf-pilot/datasets/jit_dp/apachejit_llm_small.jsonl --model_path /speed-scratch/a_s87063/repos/perf-pilot/LLMs/pretrained/causal-lm/meta-llama/Meta-Llama-3-8B --quant --lora --bf16 --gradient_checkpointing --truncation_len 200 --chunking_len 100 --debug
